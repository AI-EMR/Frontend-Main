  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow-soft rounded-lg p-8 max-w-md w-full mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Welcome to AIEMR</h2>
        <p className="mt-2 text-gray-600 dark:text-gray-300">Sign in to your account</p>
        <div className="mt-4 text-sm text-gray-500">
          <p>For demo purposes, use any of these emails:</p>
          <ul className="mt-1 space-y-1">
            <li>admin@example.com</li>
            <li>doctor@example.com</li>
            <li>nurse@example.com</li>
            <li>reception@example.com</li>
            <li>patient@example.com</li>
          </ul>
          <p className="mt-1">with any password (min 6 characters)</p>
        </div>
      </div>
